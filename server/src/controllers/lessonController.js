...
exports.getLesson = async (req, res, next) => {
    try {
        ...
        const lesson = await Lesson.findOne({ slug, isPublished: true, isDeleted: false })
            .populate('vocabularies', 'word meaning pronunciation audioUrl type image') // Lấy thông tin từ vựng để hiển thị popup
