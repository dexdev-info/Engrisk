// pages/MyVocabularyListPage.jsx
...
const MyVocabularyListPage = () => {
  const { status } = useParams()
  const navigate = useNavigate()

  const meta = STATUS_META[status]

  const { vocabs, loading, error } = useMyVocabularyList({
    status,
    limit: 50
  })
...
export default MyVocabularyListPage
