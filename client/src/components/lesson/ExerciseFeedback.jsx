  ...
  return (
    <div
      className={`
        ...
        ${
          isCorrect
            ? 'border-emerald-500 bg-emerald-50/50' // Đúng: Xanh rất nhạt
            : 'border-red-500 bg-red-50/50' // Sai: Đỏ rất nhạt
        }
      `}
    >
      {/* 1. Status Row */}
      ...
      {/* 2. Correct Answer (Chỉ hiện khi sai) - Làm nổi bật rõ ràng */}
      {!isCorrect && (
