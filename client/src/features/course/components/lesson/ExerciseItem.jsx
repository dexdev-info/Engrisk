...
import { useExercise } from '@/features/course/hooks/useExercise.js'
  ...
  return (
    <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
      ...
      <div className="flex gap-4 mb-5">
        <span className="shrink-0 w-8 h-8 bg-gray-700 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-sm">
          {index + 1}
        </span>
